...
<div class="w-64 bg-[#20496b] text-white p-6">
  ...
  <ul class="space-y-2">
    <li>
      <a href="dashboard.php" class="flex items-center gap-3 p-3 rounded-lg transition
    ...
    <li>
      <a href="users.php" class="flex items-center gap-3 p-3 rounded-lg transition
    ...
    <li>
      <a href="products.php" class="flex items-center gap-3 p-3 rounded-lg transition
